...
const Analysis = () => {
  ...
  const [dateRange, setDateRange] = useState({ from: "Feb 8, 2025", to: "Feb 14, 2025" });
  ...
  const monthWiseData = [
    { name: "Dec '24", Frustration: 33, Threat: 39, Slang: 3, Abuse: 0, Sarcasm: 0 },
    { name: "Jan '25", Frustration: 167, Threat: 92, Slang: 29, Abuse: 0, Sarcasm: 3 },
    { name: "Feb '25", Frustration: 123, Threat: 57, Slang: 1, Abuse: 0, Sarcasm: 0 },
  ];
  ...
  return (
    <Layout>
      <div className="dashboard-container-analy">
        <div className="card-container">
          {[
            { title: "CQ Score%", value: "80%", color: "text-red-600" },
            {
              title: "Without Fatal CQ Score%",
              value: "84%",
        ...
        <div className="section-box">
          ...
          <div className="section-content">
            <div className="alert-box">
              ...
              <p><b>Feb 12</b> - Lead ID (654321) - Customer mentioned social media escalation.</p>
            </div>
        ...
        <div className="section-box">
          ...
          <div className="section-content">
            <div className="alert-box">
              ...
              <p><b>Feb 09</b> - Lead ID (456789) - Suspicious transaction flagged.</p>
            </div>
            <table className="data-table">
              <thead>
                <tr>
        ...
        <div className="competitor-table">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr><td>Flipkart</td><td>2</td></tr>
              <tr><td>BuyZone Attwin</td><td>1</td></tr>
              <tr><td>BuyZone Attwin</td><td>1</td></tr>
              <tr><td>BuyZone Attwin</td><td>1</td></tr>
              <tr><td>BuyZone Attwin</td><td>1</td></tr>
              <tr><td>BuyZone Attwin</td><td>1</td></tr>
